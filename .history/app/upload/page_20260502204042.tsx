...
export default function ResumeUploader() {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            setResult(normalized);       // local UI
            setResultStore(normalized);  // global persist
            ...
            if (jobData.success) {
                ...
                toast.success("Resume Analyzed .Jobs is Matched According To your Skills on DashBoard") // ✅ Zustand only
            }
          ...
          ${uploadedFile
                ...
                {result && (
                    <div ref={resultRef} className="mt-16 max-w-3xl mx-auto space-y-4">
                        ...
                        <Link href={"/dashboard"} className="cursor-pointer bg-blue-700 p-2 rounded ">Go to DashBoard</Link>
