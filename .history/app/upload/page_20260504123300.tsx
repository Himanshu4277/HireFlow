          ...
          ${uploadedFile
                ...
                {result && (
                    <div ref={resultRef} className="mt-16 max-w-3xl mx-auto space-y-4">
                        ...
                        <button
                            onClick={downloadPDF}
                            className="p-2 text-white bg-green-500 text-black rounded-lg"
                        >
                            ⬇ Download PDF
                        </button>

                        <Link href={"/dashboard"} className="cursor-pointer bg-blue-700 p-3 ml-2 rounded-lg ">Go to DashBoard</Link>
